...
<link href="/admin-skins/js/swfupload/swfupload.css?v={{config("sys.version")}}" rel="stylesheet">
<script type="text/javascript" src="/admin-skins/js/zclip/jquery.zclip.min.js?v={{config("sys.version")}}" ></script>
<style type="text/css">
...
.checkbox_icon{display:block;float:left;margin-right:5px;width:16px;height:16px;background:url('/admin-skins/img/checkbox_icon.png') 0 0;}
                ...
                <div class="ibox-content">
                    <div class="file-manager">
                        ...
                        <ul class="folder-list" style="padding: 0">
                            ...
                            <li><a href="{{ U('foundation.resources.manage')}}?folder={{ $dir->getPrefix() }}"><i class="fa fa-folder"></i> {{ $dir->getPrefix() }}</a></li>
                            @endforeach
                        </ul>
                        @endif
...
<script type="text/javascript" src="/admin-skins/js/swfupload/swfupload.js?v={{config("sys.version")}}" ></script>
<script type="text/javascript" src="/admin-skins/js/swfupload/swfupload.queue.js?v={{config("sys.version")}}" ></script>
<script type="text/javascript" src="/admin-skins/js/swfupload/fileprogress.js?v={{config("sys.version")}}" ></script>
<script type="text/javascript" src="/admin-skins/js/swfupload/handlers.js?v={{config("sys.version")}}" ></script>
<script type="text/javascript">
	...
	function initUploadControl(id, num, rename) {
		var settings = {
			...
			upload_url : "<?php echo U('foundation.attachment.upload'); ?>",
	...
	//复制链接
	$(".copy-btn").zclip({
		path: "/admin-skins/js/zclip/ZeroClipboard.swf",
		copy: function(){
