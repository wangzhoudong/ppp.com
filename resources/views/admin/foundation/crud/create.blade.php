                            ...
                            <form name="form_product" id="form-validation" action="" class="form-horizontal form-validation" accept-charset="UTF-8" method="post">
                               ...
                               <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input id="c_service" name="service" class="form-control" required="" aria-required="true"  value="{{ $data['link'] or ''}}" placeholder="Service不能为空">
                                        <div id="alert_service" class="alert-danger"></div>
                                    </div>
                                </div>
                                <div class="form-group">
	...
	<script type="text/javascript">
        ...
        $(function() {
			$("#c_table").change(function(){
                ...
                $("#c_service").val(PathtableTo).trigger("change");;
