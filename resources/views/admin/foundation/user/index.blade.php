				    ...
				    <div class="row">
						...
						@if(role('Foundation/User/create'))
							<div class="col-sm-3 pull-right">
								<a href="{{ U('Foundation/User/create')}}" class="btn btn-sm btn-primary pull-right">添加</a>
							</div>
						@endif
					</div>
					<table class="table table-striped table-bordered table-hover dataTables-example dataTable">
						<thead>
							<tr>
								...
								<th class="sorting" data-sort="position_name">职位</th>
								<th class="sorting" data-sort="department_name">部门</th>
								<th>相关操作</th>
							</tr>
						</thead>
						<tbody>
						@if(isset($list))
							...
							<tr>
                                ...
                                <td>{{ $item->position_name or '' }}</td>
                                <td>{{ $item->department_name or '' }}</td>
								<td>
									<div class="btn-group">
										...
										<ul class="dropdown-menu">
											...
											<li><a href="{{ U('Foundation/User/update')}}?id={{ $item->id }}" class="font-bold">修改</a></li>
											@endif
										</ul>
									</div>
								</td>
