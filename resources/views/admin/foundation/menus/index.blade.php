				...
				<div class="ibox-content">
					<div class="row">
						...
						<div class="col-sm-3 pull-right">
							<a href="{{ U('Foundation/Menus/create')}}" class="btn btn-sm btn-primary pull-right">添加</a>
						</div>
						@endif
					</div>
								...
								<td>
									<div class="btn-group">
										...
										<ul class="dropdown-menu">
											@if(role('Foundation/Menus/create'))
										    <li><a href="{{ U('Foundation/Menus/create',['pid'=>$val['id']])}}" class="font-bold">添加子菜单</a></li>
										    @endif

											@if(role('Foundation/Menus/update'))
											<li class="divider"></li>
											<li><a href="{{ U('Foundation/Menus/update',['id'=>$val['id']])}}" class="font-bold">修改</a></li>
											@endif

											@if(role('Foundation/Menus/destroy'))
											<li class="divider"></li>
											<li><a href="{{ U('Foundation/Menus/destroy',['id'=>$val['id']])}}" onclick="return confirm('你确定执行删除操作？');">删除</a></li>
											@endif
										</ul>
									</div>
								</td>
