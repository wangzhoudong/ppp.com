...
class MenusController extends Controller
{
    ...
    function index ()
    {
        ...
        return view('admin.foundation.menus.index', compact('list'));
    }
    ...
    public function create ()
    {
        ...
        $this->_showEdit();
        return view('admin.foundation.menus.edit');
    }
    ...
    private function _createSave ()
    {
        ...
        if (isset($id->id)) {
            ...
            $url[] = array(
                    'url' => U( 'Foundation/Menus/index'),
                    'title' => '返回列表'
            );
            $url[] = array(
                    'url' => U( 'Foundation/Menus/create'),
                    'title' => '继续添加'
            );
    ...
    public function update ()
    {
        ...
        return view('admin.foundation.menus.edit', compact('data'));
    }
