...
class UserController extends Controller
{
    ...
    function index()
    {
        ...
        return view('admin.foundation.user.index', compact('list', 'roles'));
    }
...
//        var_dump(crypt('abcded', $pwd));exit;
        ...
        $list = $this->_service->search($search, $orderby);
        return view('admin.foundation.user.resetPwd', compact('list'));
    }
    ...
    public function create()
    {
        if(Request::method() == 'POST'){
            ...
            if($this->_service->create($data)){
                ...
                $this->showWarning('操作失败'  . $this->_service->getMessage(), urldecode(Request::input('_referer')));
            }
        }
        ...
        return view('admin.foundation.user.edit', compact('data', 'roles'));
    }
    ...
    public function auth() {
        ...
        return view('admin.foundation.user.auth', compact( 'roles'));
    }
