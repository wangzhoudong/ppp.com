...
abstract class Controller extends BaseController
{
    ...
    public function __construct() {
		...
		if( !$this->_serviceAdminRole ) $this->_serviceAdminRole = new \App\Services\User\Role();
		if(isset($this->_user['admin_role_id'])) {
		$roleInfo = $this->_serviceAdminRole->find($this->_user['admin_role_id']);
		$this->_user['admin_role_name'] = isset($roleInfo->name) ? $roleInfo->name : '管理员';
		}
	...
	public function _showMessage($msgs, $links, $data, $code, $redirect)
	{
	    ...
	    $html ='<!DOCTYPE html>
                ...
                <head>
                    ...
                    <link href="/admin-skins/css/style.min.css?v=3.0.0.css"  rel="stylesheet">
